...
<html>
    ...
    <body>
        ...
        <form action="registrarSector" method="post">
            <label for="nombre">Nombre Sector</label>   <input type="text" name="nombre" max="45"/><br>
            ...
            <label for="rcto">Recinto</label>   <input type="text" name="rcto" max="45"/> <br>
            <label for="direccion">Dirección</label>   <input type="text" name="direccion" max="45"/> <br>
            <label for="email">Correo Electrónico</label>   <input type="text" name="email" max="50"/>    <br>         
            <label for="apellido">Observación</label>   <textarea name="observacion" cols="1" rows="10"></textarea> <br>
            <label for="responsable">Responsable</label>   <input type="text" name="responsable" max="50"/> <br>
